...
public class SummaryRecord {
	...
	/*commented by Jyothi
	 * 	START
	 * 	Basically this method orders the contextpairs and fieldpairs in order.
	 * 	If one of the pairs is empty, it simply adds other type of pairs
	 * 	Otherwise, adds both the types together in the increasing order of their IDs 
	 *  Note that none of the pairs are removed, in contrast to the theory presented in the paper. 
	 *  One more clarification: ctx summary and the field summary are after canceling the opp. edges I think. No not true again!
	 * 	END*/
