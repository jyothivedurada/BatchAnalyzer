...
public class TraverseTupleOld {
	public static int IN = 0;
	public static int OUT = 1; 
	public static int NONE = -1;
	
	private static Set<TraverseTupleOld> quads = new HashSet<TraverseTupleOld>();	
	...
	private TraverseTupleOld(AbstractAllocNode n, LinkedList<Edge> cs, LinkedList<FieldPTEdge> fs, HashSet<AbstractSPGEdge> visitedCtxEdges,
		HashSet<Pair<FldPair, Integer>> visitedFldEdges, int ctxHash, AbstractSPGEdge prevEdge) {
		this.node = n;
		this.ctxStk = cs;
		this.fldStk = fs;
	...
	public static TraverseTupleOld getTuple(AbstractAllocNode n, LinkedList<Edge> cs, LinkedList<FieldPTEdge> fs, HashSet<AbstractSPGEdge> visitedCtxEdges,
		HashSet<Pair<FldPair, Integer>> visitedFldEdges, int ctxHash, AbstractSPGEdge prevEdge) {
		TraverseTupleOld quad = new TraverseTupleOld(n, cs, fs, visitedCtxEdges, visitedFldEdges, ctxHash, prevEdge);
		quads.add(quad);
		return quad;		
	}
